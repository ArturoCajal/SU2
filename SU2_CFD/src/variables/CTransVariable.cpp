...
#include "../../include/variables/CTransVariable.hpp"


CTransVariable::CTransVariable(unsigned long npoint, unsigned long ndim, unsigned long nvar, CConfig *config)
  ...
  /*--- Always allocate the slope limiter, and the auxiliar
   variables (check the logic - JST with 2nd order Trans model) ---*/
